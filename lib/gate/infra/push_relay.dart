...
Future<void> dashBackgroundMessage(RemoteMessage _) async {}

/// Firebase Messaging + APNs plumbing: token warm-up, foreground presentation,
/// cold/warm push destination extraction, and permission requests.
class PushRelay {
  PushRelay(this._store, {required this.enabled});
  ...
  Future<void> _boot() async {
    ...
    FirebaseMessaging.onBackgroundMessage(dashBackgroundMessage);
